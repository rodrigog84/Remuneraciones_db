...
public function previred($datos_remuneracion, $idcentrocosto = null){
			...
			foreach ($datos_remuneracion as $remuneracion) {
				...
				$tipojornada = $remuneracion->parttime == 0 ? str_pad(1, 8, "0", STR_PAD_LEFT) : str_pad(2, 8, "0", STR_PAD_LEFT);
