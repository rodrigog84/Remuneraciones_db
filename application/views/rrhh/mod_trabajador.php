										...
										<div class="tab-content">
											...
											<div class="tab-pane" id="datosempresa">
												...
												<div class='row'>
												 ...
												 <div class='col-md-6'>
								                            <div class="form-group">
								                                <label for="nombre">Sueldo Anterior Licencia</label>  
								                                 <input type="text" name="sueldo_previo" class="form-control" id="sueldo_previo" placeholder="Sueldo Previo" value="0">
								                                 <small class="help-block"  >(*) En caso de llenar este campo, se considerar&aacute; para cálculos de renta imponible&nbsp;</small>
								                            </div>
								                          </div>								                          
						                        ...
						                        <div class='row'>
						                          ...
						                          <div class='col-md-6'>
						                            <div class="form-group">
						                              ...
						                              <input type="text" class="form-control" name="diastrabajosemanal" id="diastrabajosemanal" placeholder="Ingrese D&iacute;as de Trabajo Semanal" value="<?php echo $datos_form['diastrabajosemanal']; ?>" >                            
						                            </div> 
						                          </div>							                        	
														...
														<div class='col-md-6'>
								                            <div class="form-group">
								                              <label for="rut">Plazo Contrato</label>
																...
																<input placeholder="Fecha Real" class="form-control mask_date" id="plazo_contrato" name="plazo_contrato" type="text" value="" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
																</div>
								                              ...
								                              <label for="rut">Isapre</label>
																<select name="isapre" id="isapre" class="form-control">
						                                    		...
						                                    		<?php foreach ($isapres as $isapre) { ?>
								                                      <?php //$isapreselected = $isapre->id_isapre == $datos_form['id_isapre'] ? "selected" : ""; ?>
...
$(document).ready(function(){
	$.ajax({type: "GET",
		    		...
		    		success: function(datos_personal2){
        				...
        				$("#sueldo_previo").val(this.sueldoprevio);
        				...
        				if(this.instapv == 0){
						  ...
						  if(this.idisapre == '' || this.idisapre == 1){ // sin selección o marcó sin mutual
						    $('#monto_pactado').val('');
        				...
        				if(this.tipocontrato == '' || this.tipocontrato == 'I'){
						    $('#plazo_contrato').val('');
						    $('#plazo_contrato').attr('disabled',true);
						  }else{
						    $('#plazo_contrato').attr('disabled',false);
        					$("#plazo_contrato").val(this.plazo_contrato);
        				}
        				...
        				$("#diastrabajosemanal").val(this.diastrabajosemanal);
        				...
        				$('#sueldo_previo').mask('000.000.000.000.000', {reverse: true});
          ...
          /*  centro_costo: {
            ...
            /*sueldo_base: {
  			...
  			sueldo_previo: {
                ...
                validators: {
                    notEmpty: {
                        message: 'Sueldo Previo es requerido'
                    },
                    // The bank validator doesn't have any option
                    blank: {}  
                }
