...
<div class="sub-heard-part">
		...
		<div class="graph-visual tables-main">											
								...
								<td>			
								<a href="<?php echo base_url();?>rrhh/submit_genera_carta_personal/<?php echo $documentos->id_doc_colaborador?>" class="btn btn-info opciones" id="opciones" title="Contrato"><i class="fa fa-pencil-square-o" aria-hidden="true" role="button"></i></a>						
								</td>
								</tr> 
