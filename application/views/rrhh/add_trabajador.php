...
<!--sub-heard-part--><form id="basicBootstrapForm" action="<?php echo base_url();?>rrhh/submit_trabajador" method="post">
<!--sub-heard-part-->
								                            ...
								                            <div class="form-group">
							                                   ...
							                                   <option value="">Seleccione Estado Civil</option>
								                                    <?php foreach ($estados_civiles as $estado_civil) { ?>
								                                      <?php $ecivilselected = $estado_civil->id_estado_civil == $datos_form['idecivil'] ? "selected" : ""; ?>
								                              ...
								                              <label for="rut">Estudios</label>
								                             	<select name="estudios" id="estudios" class="form-control">
						                                    		...
						                                    		<?php foreach ($estudios as $estudio) { ?>
								                                      <?php $estudioselected = $estudio->id_estudios == $datos_form['idestudio'] ? "selected" : ""; ?>
								                              ...
								                              <label for="rut">Idioma</label>
								                             	<select name="idioma" id="idioma" class="form-control">
						                                    		...
						                                    		<?php foreach ($idiomas as $idioma) { ?>
								                                      <?php $idiomaselected = $idioma->id_idioma == $datos_form['ididioma'] ? "selected" : ""; ?>
								                            ...
								                            <div class="form-group">
								                                ...
								                                <select name="licencia" id="licencia" class="form-control">
						                                    		...
						                                    		<?php foreach ($licencias as $licencia) { ?>
								                                      <?php $licenciaselected = $licencia->id_licencia_conducir == $datos_form['idlicencia'] ? "selected" : ""; ?>
								                                ...
								                                <label for="nombre">Categoria</label>  
								                                 <select name="categoria" id="categoria" class="form-control">
						                                    		...
						                                    		<?php foreach ($categorias as $categoria) { ?>
								                                      <?php $categoriaselected = $categoria->id_categoria == $datos_form['idcategoria'] ? "selected" : ""; ?>
								                              ...
								                              <label for="rut">Lugar de Pago</label>
								                             	<select name="lugar_pago" id="lugar_pago" class="form-control">
						                                    		...
						                                    		<?php foreach ($lugar_pago as $lugar_pagos) { ?>
								                                      <?php $lugarpagosselected = $lugar_pagos->id_lugar_pago == $datos_form['idlugarpago'] ? "selected" : ""; ?>
								                              ...
								                              <label for="rut">A.F.P</label>
																<select name="afp" id="afp" class="form-control">
						                                    		...
						                                    		<?php foreach ($afps as $afp) { ?>
								                                      <?php $afpselected = $afp->id_afp == $datos_form['idafp'] ? "selected" : ""; ?>
