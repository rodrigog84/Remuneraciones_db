                            ...
                            <?php if(count($personal) > 0 ){ ?>
                              ...
                              <?php foreach ($personal as $trabajador) { ?>
                               ...
                               <tr >
                                ...
                                <td >
                                    <center><a href="<?php echo base_url();?>rrhh/crear_documentos_colaborador/<?php echo $trabajador->id_personal;?>" data-toggle="tooltip" title="Crear Documento" ><i class="fa fa-plus-square fa-lg"></i></a></center>
                                </td>                                
                                <!--td >
