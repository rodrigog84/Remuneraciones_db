                            ...
                            <?php if(count($personal) > 0 ){ ?>
                              ...
                              <?php foreach ($personal as $trabajador) { ?>
                               ...
                               <tr >
                                ...
                                <td><?php echo isset($distribucion[$trabajador->id_personal])  ? $distribucion[$trabajador->id_personal] : 0;?></td>
                                <td >
                                    <center><a href="<?php echo base_url();?>rrhh/distribucion_colaborador_ccosto/<?php echo $trabajador->id_personal;?>" data-toggle="tooltip" title="Crear Distribuci&oacute;n" ><i class="fa fa-plus-square fa-lg"></i></a></center>
                                </td>                                
                                <!--td >
