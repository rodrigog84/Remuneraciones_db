    ...
    <div id="page-container" class="page-container fade">
        ...
        <div class="error">
            ...
            <div class="error-content">
                <div class="error-message">Ha ocurrido un error en la transacci&oacute;n!</div>
                <div class="error-desc m-b-20">
                     Intente nuevamente o cont&aacute;ctese con el administrador del sitio a <a href="mailto:contacto@arnou.cl">contacto@arnou.cl</a>
                </div>
                <div>
                    <a href="<?php echo base_url();?>" class="btn btn-success">Volver al Inicio&nbsp;&nbsp;</a>
                </div>
            </div>
        </div>
