<div class="panel panel-inverse">                       
    <div class="panel-heading">
        <h4 class="panel-title">Ingreso de Licencias</h4>
    </div>
                            ...
                            <?php if(count($personal) > 0 ){ ?>
                              ...
                              <?php foreach ($personal as $trabajador) { ?>
                               ...
                               <tr >
                                ...
                                <td >
                                    <center><a href="<?php echo base_url();?>auxiliares/add_licencias/<?php echo $trabajador->id_personal;?>" data-toggle="tooltip" title="Agregar Licencia" ><i class="fa fa-plus-square"></i></a></center>
                                </td>                                
                                <!--td >
